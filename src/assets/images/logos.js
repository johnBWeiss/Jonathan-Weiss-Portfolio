...
import info from '../../assets/images/logos/info.png'
...
import vuetify from '../../assets/images/logos/vuetify.png'
import redux from '../../assets/images/logos/redux.png'
import home from '../../assets/images/logos/home.png'
import tech from '../../assets/images/logos/tech.png'
...
import YCV from '../../assets/Yonatan Front End CV - Remote.pdf'
...
const logos = {
    ...
    building: { src: building, title: "Driven to build every project to completion" }, creativity: { src: creativity, title: "Creative with a great passion for front end design" }, location: {
        src: location, title: 'Open for remote work in the US'
